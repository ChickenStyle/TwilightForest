...
public class BiomeBuilder {
    ...
    public BiomeBase build(TFBiome b) {
        return build(b.getFogColor(),b.getWaterColor(),b.getWaterFogColor(),b.getSkyColor(),b.getGrassColor(),b.getFoliageColor());
    }
    ...
    public BiomeBase build() {
        ...
        BiomeFog.a biomeFogCodec = new BiomeFog.a()
                ...
                .f(Integer.parseInt(grassColor,16));
